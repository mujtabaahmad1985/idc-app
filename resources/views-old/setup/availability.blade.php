...
@section('css')
    {!! Html::style('public/material/css/jquery-ui-timepicker-addon.css') !!}
<style>
...
<div class="col-sm-12 col-md-12 col-lg-8">
                ...
                <div class="card show-availability">
                    ...
                    <div id="doctor{!! $doctor->id !!}" class="collapse" data-parent="#accordion-default">
                        <div class="card-body">
...
@section('js')
    ...
    {!! Html::script('/public/material/js/jquery-ui-timepicker-addon.js') !!}
