...
@section('content')
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 text-right float-sm-right"><button class="btn btn-danger addservice">Add New Service</button> </div>
                </div>
                    ...
                    <form class="" id="user-form" method="post" action="/service/add_service" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <input id="service_name" name="service_name" type="text" class="form-control"  data-error=".errorTxt1">
