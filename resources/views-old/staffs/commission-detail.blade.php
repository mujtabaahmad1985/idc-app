@extends('layout.app')
@section('page-title') Staff Management | Commission Detail @endsection
@section('css')
...
@section('content')
    ...
    <!--start container-->
        <div class="container">
            <div class="row">
                <h4 class="header col s6">My Commissions in month of March</h4>
                        ...
                        <table class="responsive-table staff-table" style="margin-top: 30px">
                            ...
                            @for($i=1;$i<=12;$i++)
                                <tr>
                                    ...
                                    <td>Product {!! $i !!}</td>
                                    <td>{!! str_shuffle('abceiowes') !!}{!! rand(100,500) !!}</td>
                                    <td>{!! rand(100,500) !!}</td>
                                    <td>{!! number_format('200',2).' SGD' !!}</td>
                                    <td>{!! number_format('20',2).' SGD' !!}</td>
                            ...
                            <tr style="border-top: 1px solid #ddd; padding-top: 10px">
                                <td colspan="5"></td>
                                <td  align="right" style=" padding-right: 30px; padding-top: 10px; font-size: 16px; font-weight: bolder"><strong>Total: </strong></td>
                                <td colspan="2" style=" padding-right: 30px;padding-top: 10px; font-size: 16px; font-weight: bolder">{!! number_format('23232150',2).' SGD' !!}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
