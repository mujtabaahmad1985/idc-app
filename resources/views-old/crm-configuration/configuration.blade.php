    ...
    <div class="content">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Treatment Card Element Settings </h5>
            ...
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    <ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-200 mb-md-0 border-bottom-0">
                        ...
                        <li class="nav-item"><a href="#tooth-area" data-tab="tooth-area" class="nav-link" data-toggle="tab"><i class="icon-microscope mr-2"></i> Tooth Areas</a></li>
                    </ul>
