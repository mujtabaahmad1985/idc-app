                            ...
                            <div class="row new-phone">
                                ...
                                <div class="col-sm-8 form-group">
                                    <input id="new_contact_number{!! $ph->id !!}" name="new_contact_number[]"
                                           ...
                                           class="validate contact_number form-control input-sm">
                                </div>
                            ...
                            <div class="container">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" @if(isset($medical->is_medication) && $medical->is_medication == "Yes") checked @endif class="custom-control-input" id="is_medication"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input"  id="is_allergic" @if(isset($medical->is_allegric) && $medical->is_allegric == "Yes") checked @endif  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="ilnessess[]"  @if(isset($medi) && !is_null($medi) && in_array('allergie',$medi)) checked
                                                       @endif  value="allergie" class="custom-control-input" id="allergie"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="ilnessess[]" @if(isset($medi) && !is_null($medi) && in_array('high_blood_pressure',$medi)) checked
                                                       @endif value="high_blood_pressure" class="custom-control-input" id="high_blood_pressure"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="ilnessess[]"  @if(isset($medi) && !is_null($medi) && in_array('gastric_problems',$medi)) checked
                                                       @endif value="gastric_problems" class="custom-control-input" id="gastric_problems"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="ilnessess[]"  @if(isset($medi) && !is_null($medi) && in_array('asthma',$medi)) checked
                                                       @endif value="asthma" class="custom-control-input" id="asthma"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="ilnessess[]"  @if(isset($medi) && !is_null($medi) && in_array('head_neck_injuries',$medi)) checked
                                                       @endif value="head_neck_injuries" class="custom-control-input" id="head_neck_injuries"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" @if(isset($medi) && !is_null($medi) && in_array('diabetes',$medi)) checked
                                                       @endif  name="ilnessess[]" value="diabetes" class="custom-control-input" id="diabetes"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" @if(isset($medi) && !is_null($medi) && in_array('heart_disease',$medi)) checked
                                                       @endif name="ilnessess[]" value="heart_disease" class="custom-control-input" id="heart_disease"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"  @if(isset($medi) && !is_null($medi) && in_array('liver_problems',$medi)) checked
                                                       @endif  name="ilnessess[]" value="heart_disease" class="custom-control-input" id="liver_problems"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" @if(isset($medi) && !is_null($medi) && in_array('eilepsy',$medi)) checked
                                                       @endif name="ilnessess[]" value="heart_disease" class="custom-control-input" id="epilepsy"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" @if(isset($medi) && !is_null($medi) && in_array('herpes',$medi)) checked
                                                       @endif name="ilnessess[]" value="herpes" class="custom-control-input" id="herpes"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input  @if(isset($medi) && !is_null($medi) && in_array('respiratory',$medi)) checked
                                                        @endif type="checkbox" name="ilnessess[]" value="respiratory" class="custom-control-input" id="respiratory"  >
