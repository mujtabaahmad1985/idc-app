    ...
    <button class="btn bg-danger-700 colorpicker-basic" type="button"><i class="icon-brush"></i></button><button class="btn bg-danger-700 save-new-data"
                            ...
                            <div id="accordion-item-default3" class="collapse" data-parent="#accordion-default"
                                ...
                                <div class="card-body ">
                                    ...
                                    <select class="form-control" multiple id="current-medications">
                                        <option value="Ex. Advil">Ex. Advil</option>
                                        <option value="Ponstan">Ponstan</option>
                                        <option value="Amaxil">Amaxil</option>
                                    </select>
                                    </div>
                                    <div class="row mt-2">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="card border-top-danger card-element">
                            ...
                            <div id="accordion-item-default4" class="collapse" data-parent="#accordion-default"
                                 style="">
                                <div class="card-body medical-history-card" contenteditable="">
                                ...
                                <a href="#!" class="btn btn-danger btn-sm ml-3 mb-1 history-btn" style="display: none">Save</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Treatment Sessions</h6>

                            </div>

                            <div class="card-body sessions">
                                <ul class="nav nav-tabs nav-tabs-bottom">
                                    <li class="nav-item"><a href="#session1" class="nav-link active show"
                                                            data-toggle="tab">1. Session on <span
                                                    class="font-size-base text-muted">12.09.2019 12:55</span></a></li>
                                    <li class="nav-item"><a href="#session2" class="nav-link" data-toggle="tab">2.
                                            Session on <span
                                                    class="font-size-base text-muted">12.09.2019 12:55</span></a></li>
                                    <li class="nav-item"><a href="#session3" class="nav-link" data-toggle="tab">3.
                                            Session on <span
                                                    class="font-size-base text-muted">12.09.2019 12:55</span></a></li>
                                    <li class="nav-item"><a href="#session4" class="nav-link" data-toggle="tab">4.
                                            Session on <span
                                                    class="font-size-base text-muted">12.09.2019 12:55</span></a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="session1">
                                        <div class="card card-body border-top-danger">
                                            <div class="row">
                                                <div class="float-left ml-2"><h6 class="mb-0 font-weight-semibold">
                                                        Area:</h6></div>
                                                <div class="float-left">
                                                    <select class="form-control multiselect-link patient-teeth-area"
                                                            data-button-width="500" multiple="multiple" data-fouc>
                                                        <option value="Full Mouth Check-Up" selected>Full Mouth
                                                            Check-Up
                                                        </option>
                                                        <option value="Upper Partial Denture" data-color="#d50000">Upper
                                                            Partial Denture
                                                        </option>
                                                        <option value="Lower Partial Denture" data-color="#ffeb3b">Lower
                                                            Partial Denture
                                                        </option>
                                            ...
                                            <p class="mb-0 text-muted">by <a href="#!">Dr Soe Nyunt San</a> at <a
                                                        href="#!">IDC Myanmar </a></p>
                                            ...
                                            <dl class="mb-0">
                                                ...
                                                <dd class="mb-0" style="text-transform: none">
                                    ...
                                    <div class="tab-pane fade" id="session2">
                                        <div class="card card-body border-top-danger">
                                            <div class="row">
                                                <div class="float-left ml-2"><h6 class="mb-0 font-weight-semibold">
                                                        Area:</h6></div>
                                    ...
                                    <div class="tab-pane fade" id="session3">
                                        <div class="card card-body border-top-danger">
                                            <div class="row">
                                                <div class="float-left ml-2"><h6 class="mb-0 font-weight-semibold">
                                                        Area:</h6></div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    <dl class="mb-0">
                                                        ...
                                                        <dd class="mb-1" style="text-transform: none">
                                                            <select class="select2 pre-medication" multiple>
                                                                <option></option>
                                                            </select>
                                                        </dd>
                                                        <dt>Consent</dt>
                                                        <dd class="mb-1" style="text-transform: none">
                                                            <select class="select2 consent">
                                                                <option></option>
                                                            </select>
                                                        </dd>
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <dl class="mb-0">
                                                        ...
                                                        <dt>Medications</dt>
                                                        <dd class="mb-1" style="text-transform: none">
                                                            <select class="select2 medication" multiple>
                                                                <option></option>
                                                            </select>
                                                        </dd>
                                                        <dt>Next Visit</dt>
                                            ...
                                            <div class="row mt-1">
                                                <div class="col-sm-12 text-center">
                                                    <button class="btn btn-danger  red"><i
                                                                class="icon-floppy-disk mr-1"></i> Save
                                                    </button>
                                                    <button class="btn btn-danger red" href="#!"><i
                                    ...
                                    <div class="tab-pane fade" id="session4">
                                        <div class="card card-body border-top-danger">
                                            <div class="row">
                                                <div class="float-left ml-2"><h6 class="mb-0 font-weight-semibold">
                                                        Area:</h6></div>
