...
@php
  ...
  //  echo "<pre>"; print_r($patient_pages); echo "</pre>";
    ...
    'booking_process','payments','import_customers','export_data','my-contacts','consent-forms','materials','labs','doctor-profile'];
                ...
                <li class="nav-item nav-item-submenu @if(in_array($current_page,$setup_pages)) active nav-item-open @endif">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Setup" @if(in_array($current_page,$setup_pages)) style="display: block" @endif>
                        @if(Auth::user()->role=='hospital-administrator' || in_array(19,$permissions_allowed) )
                            <li  class="nav-item "><a  class="nav-link @if($current_page==="availablity") active @endif" href="/setup/availability">Availability</a></li>
                       @endif
                           ...
                           {{-- @if(Auth::user()->role=='hospital-administrator' || in_array(27,$permissions_allowed) )
                                <li class="nav-item"><a  class="nav-link" href="">Patient Advice</a>
                                </li>
                            @endif
                            @if(Auth::user()->role=='hospital-administrator' || in_array(28,$permissions_allowed) )
                                <li class="nav-item"><a  class="nav-link" href="">Patient Education</a>
                                </li>
                            @endif
                            @if(Auth::user()->role=='hospital-administrator' || in_array(29,$permissions_allowed) )
...
{{--
                ...
                @if(Auth::user()->role=='hospital-administrator')
                    <li class="nav-item">
                    <a href="/referrals" class="nav-link"><i class="icon-link2"></i> <span>Patient Referrals</span></a>
                    </li>
                @endif
                ...
                @if(Auth::user()->role=='hospital-administrator' || in_array(31,$permissions_allowed) )
                    ...
                    <li class="nav-item nav-item-submenu @if(in_array($current_page,$reports)) active nav-item-open @endif">
                        <a href="#" class="nav-link"><i class="icon-stack2"></i>  <span>Reports</span></a>
                        <ul class="nav nav-group-sub" data-submenu-title="Reports">
                          ...
                          {{--  <li class="nav-item">
                                <a href="/pharmacy/purchase-report" class="nav-link @if(in_array($current_page,$reports) && $current_page=="purchase-report") active @endif"><span> Purchase Report</span></a>

                            </li>--}}
                            {{--<li class="nav-item">
                                <a href="/pharmacy/purchase-report" class="nav-link @if(in_array($current_page,$reports) && $current_page=="purchase-report") active @endif"><span> </span></a>
                ...
                @if(Auth::user()->role=='hospital-administrator')
                    <li class="nav-item">
                        <a href="/hospital/configuration" class="nav-link"><i class="icon-cogs"></i> <span>Hospital Configurations</span></a>
                    </li>
                @endif
