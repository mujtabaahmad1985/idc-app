                ...
                @foreach($messages as $message)
                        ...
                        <tr>
                            ...
                            <td class="table-inbox-name">
                                <a href="/message/read/{!! str_slug($message->subject) !!}?id={!! $message->id !!}&{!! md5(time()) !!}">
                            ...
                            <td class="table-inbox-message">
                                <a href="/message/read/{!! str_slug($message->subject) !!}?id={!! $message->id !!}&{!! md5(time()) !!}" class="table-inbox-subject">{!! $message->subject !!} &nbsp;-&nbsp;</a>
