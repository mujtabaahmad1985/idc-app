@extends('layout.app')
@section('page-title') Add Staff @endsection
@section('css')
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Staffs</span> - Add New</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Add new staff</span>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="email" required  class="validate form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="id_no" name="id_no" type="text"   class="alphanumaric form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="start_date" name="start_date" type="text" placeholder="dd.mm.YYYY"   class="alphanumaric datetimepicker form-control">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="end_date">End Date</label>
                                    <input id="end_date" name="end_date" type="text" placeholder="dd.mm.YYYY"   class="alphanumaric datetimepicker form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="designation" name="designation" type="text"   class="alphanumaric form-control">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="city" name="city" type="text"   class="alphanumaric form-control">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="last_name">State</label>
                                    <input id="state" name="state" type="text"   class="alphanumaric form-control">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="zipcode" name="zipcode"   class="alphanumaric form-control" type="text" >
                                </div>
                            </div>
