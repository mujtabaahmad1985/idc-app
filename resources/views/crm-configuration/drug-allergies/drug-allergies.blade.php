@extends('layout.app')
@section('page-title') Drug Allergies @endsection
@section('css')
...
<style>
    #drug-allergies-field{ height: 30px}
                    ...
                    <div class="card-panel">
                        <table class="list-table">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="row">
                                        <div class="col s12"> <h4 class="header">Drug Allergies</h4></div>

                                        <div class="col s8 m8 l10" style="position: relative"> <input type="text" style="text-transform: none;" id="drug-allergies-field" name="name"
                                                                                                      placeholder="Enter New Drug Allergy..">
                                        </div>
                                        <div class="col s4 m4 l2">
                                            <a href="#!" id="save-drug-allergy" class="btn red white-text save">Save</a>
                                        </div>
