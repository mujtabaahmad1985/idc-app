                        ...
                        <div class="row add-availability  @if($key>0) monday @endif" data-doctor="{!! $doctor['doctor_id'] !!}" data-day="monday" data-availablity="{!! $value['availability_id'] !!}">
                            ...
                            <div class="col-sm-3 start_time_slot ">
                                ...
                                @if($key==0) <label>Start Time</label> @endif
                                    <input type="text" required autocomplete="off" name="start_time" class="time start_time validate form-control input-sm check-availability" value="{!! $value['start_time'] !!}"  placeholder="hh:mm">
                            ...
                            <div class="col-sm-3 end_time_slot">
                                ...
                                {{--<select class="end_time validate" required name="end_time">
                                    ...
                                    <input type="text" required autocomplete="off" name="end_time" class="time end_time validate form-control input-sm check-availability" value="{!! $value['end_time'] !!}"  placeholder="hh:mm">
...
<label> Monday</label>
                        ...
                        <div class="col-md-3 start_time_slot ">
                           ...
                           {{-- <select class="start_time validate" required name="start_time">
                                ...
                                <input type="text" required autocomplete="off" name="start_time" class="time start_time validate form-control input-sm check-availability" value=""  placeholder="hh:mm">
...
<div class="form-group">
    ...
    <input type="text" required autocomplete="off" name="end_time" class="time end_time validate form-control input-sm check-availability" value=""  placeholder="hh:mm">
