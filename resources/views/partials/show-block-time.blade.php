...
<div class="card card-body">
    ...
    <div class="media">
        ...
        <div class="media-body mb-3">
            <h4 class="text-danger">Block Time</h4>
           <span class="text-muted"><i class="icon-calendar3"></i> {{ date('l d.m.Y', strtotime($block_time->booking_date)) }} <i class="icon-watch"></i>  {{ date('H:i A', strtotime($block_time->start_time)) }} -   {{ date('H:i A', strtotime($block_time->end_time)) }}</span>
            ...
            <div class="list-icons">
                <div class="list-icons-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end">
                        <a href="#" class="dropdown-item appointment-action"  data-action="cancelled"><i class="icon-cancel-square"></i> Cancel Block Time </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-sm-flex flex-sm-wrap mb-2">
        ...
        <div class="ml-sm-auto mt-2 mt-sm-0">{!! $block_time->doctor!=-1?"Dr ".$block_time->doctors->fname.' '.$block_time->doctors->lname:"All Doctors" !!}</div>
    </div>

    <div class="d-sm-flex flex-sm-wrap mb-2">
        <div class="font-weight-semibold">Room:</div>
        <div class="ml-sm-auto mt-2 mt-sm-0">{!! $block_time->room!=-1?$block_time->rooms->name:"All Rooms" !!}</div>
    </div>

    <div class="d-sm-flex flex-sm-wrap mb-2">
        <div class="font-weight-semibold">Location:</div>
        <div class="ml-sm-auto mt-2 mt-sm-0">{!! $block_time->location!=-1?$block_time->locations->name:"All Locations" !!}</div>
    </div>
...
<script>
    ...
    $(function(){
        ...
        $(".appointment-action").click(function(){
            var appointment_id = "{!! $block_time->id !!}";
