    ...
    <form class="col s12" id="slide-booking-form" action="/appointment/book" method="post" enctype="multipart/form-data">
                    ...
                    <select class="services form-control input-sm" name="service_id" data-error=".errorTxt1">
                        ...
                        @if(isset($services) && count($services) > 0)
                            ...
                            @foreach($services as $service)
                                ...
                                <option value="{!! $service->id !!}" @if( Session::get('search_service_id')==$service->id) selected @endif data-duration="{!! date('H:i', strtotime($service->duration)) !!}">{!! $service->service_name !!}</option>
        ...
        @if(empty($patient_id))
            ...
            <div class="row">
                ...
                @php
                $walkin =  \App\Rooms::where('name' ,'LIKE','%Walk%')->first()->id;
                @endphp
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Walk In</label>
                        <div class="custom-control custom-checkbox mt-2">
                            <input type="checkbox" class="custom-control-input" id="walk-in" @if($room_id==$walkin) checked @endif name="walkin" >
                            <label class="custom-control-label" for="walk-in"></label>
                        </div>
                    </div>
                </div>
            </div>
...
// echo "<pre>"; print_r($time_slots); echo "</pre>";
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" id="start_time" required autocomplete="off" name="start_time" class="time start_time validate form-control input-sm check-availability" value="{!! $start_time !!}"  placeholder="hh:mm">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" id="end_time"  name="end_time"  autocomplete="off" required  class="time  end_time  form-control input-sm  check-availability" value="{!! $end_time !!}"  placeholder="hh:mm">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <select class="doctors_staff  check-availability form-control input-sm" name="doctor_id"  @if($room_id!=$walkin) required @endif data-error=".errorTxt4">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="errorTxt5 error room-response1 signal"></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="alert bg-danger text-white alert-error-appointment">
        ...
        <label class="error">You have not granted for making appointment, contact hospital-administrator.</label>
...
<script>
        ...
        var walk_in_room = "{!! \App\Rooms::where('name' ,'LIKE','%Walk%')->first()->id !!}";

        $("#walk-in").on("change",function () {
            if($(this).is(":checked")){
             $("#slide-booking-form .rooms").val(walk_in_room).select2().trigger('change');
             $("#slide-booking-form .doctors_staff").removeAttr('required');
            }else{
                $("#slide-booking-form .rooms").val('').select2().trigger('change');
                $("#slide-booking-form .doctors_staff").attr('required','required');
            }
        });
              ...
              /*  if(!is_end_date_changed){
                ...
                $("#slide-booking-form").ajaxForm(function(response){
                    ...
                    if(response.type=="success"){
                        ...
                        $('.alert-error-appointment').html(response.message);

                        $('.alert-error-appointment').fadeIn();
