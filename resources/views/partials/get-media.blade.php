...
<div class="row">
    <div class="col-sm-10">
        <a class="btn btn-danger text-white add-upload-media" data-appointment-id="" data-treatment-id="" data-patient-id="{!! $patient_id !!}"><i class="icon-file-upload"></i> Upload Media</a>
    </div>
        ...
        $(".add-upload-media").click(function(){
            ...
            $.ajax({
                ...
                success:function (response) {
                    ...
                    var total_files = 0,completed_files =0;
                        ...
                        init:function(){
                            ...
                            this.on("complete", function (file) {
                                ...
                                if (completeFiles === totalFiles) {
                                    ...
                                    $.ajax({
                                        url:'/get/media/list',
                                        data:{"_token":"{!! csrf_token() !!}",data:existing_data},
                                        type:"post",
                                        success:function (response) {
                                            $(".layout-output").html(response);
