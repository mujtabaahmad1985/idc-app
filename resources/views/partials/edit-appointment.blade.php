        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" id="start_time" required autocomplete="off" name="start_time" class="time start_time validate form-control input-sm check-availability" value="{!! date('H:i', strtotime($appointment->start_time)) !!}"  placeholder="hh:mm">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" id="end_time" name="end_time" required  autocomplete="off"  class="time  end_time  form-control input-sm  check-availability" value="{!! date('H:i', strtotime($appointment->end_time)) !!}"  placeholder="hh:mm">
