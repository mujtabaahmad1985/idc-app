                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="email" name="patient_email" type="email"  class="validate email form-control">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="is_medication" name="is_medication"  >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="is_allergic" name="is_allergic"  >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="ilnessess[]" value="{!! $medication_condition->name !!}" class="custom-control-input" id="medication_condition_{!! $medication_condition->id !!}"  >
