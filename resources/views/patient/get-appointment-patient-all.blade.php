    ...
    @if($appointments && !is_null($appointments))
        ...
        @foreach($appointments as $appointment)
            <tr>
                ...
                <td style="padding-top: 9px;"><a href="#!" class="edit" data-appointment-id="{!! $appointment->appointment_id !!}">Edit</a> | <a href="#!" class="delete"  data-appointment-id="{!! $appointment->appointment_id !!}">Delete</a> </td>
            </tr>
        @endforeach
    @endif
</table>
