                        ...
                        <div class="card">
                            ...
                            <div class="card-body sessions">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bottom">
                                    ...
                                    <li class="nav-item"><a href="#session{!! $session->id !!}" class="nav-link @if($k==0) active show @endif "
                                                            data-toggle="tab"><i class="icon-calendar3 mr-1"></i> {!! $k+1 !!}. Session on <span
                                                    class="font-size-base text-muted">{!! $session->created_at !!}</span></a></li>
                                        @endforeach
