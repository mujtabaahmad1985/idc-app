            ...
            <div class="modal-body">
                ...
                <span>
                  <button type="button" class="btn btn-default-outline btn-block rounded" data-dismiss="modal">Cancel</button>
                        ...
                        <span>
                  <a href="#!"  class="btn btn-primary btn-block rounded submit-forgot-password">Submit</a>
                </span>
                    </div>
                </form>
                <div class="alert bg-success message success"></div>
                <div class="alert bg-danger message error"></div>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
    ...
    <div class="login-wrapper">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <form method="POST" id="send-link" action="/send/secure/link/login" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <div class="input-icon-left">
                            <i class="fa fa-user input-icon"></i>
                            <input type="email" class="form-control rounded" placeholder="Enter Email" required name="email">
                        </div>
                    </div><!-- /.form-group -->
                    {{--<div class="form-group">
                        <div class="input-icon-left">
                   ...
                   {{-- <div class="form-group">
                    ...
                    <button class="btn btn-primary btn-block rounded send-link">Send Link</button>
...
<script>
    $(function(){
        ...
        $(".send-link").click(function(e){
            $(".alert").hide();
            if($("#send-link").valid()){
                $("#send-link").ajaxForm(function(response){
