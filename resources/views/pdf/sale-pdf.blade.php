...
<div id="header">
    ...
    <table border="0" style="width:700px">
        <tr>
            ...
            <td width="200px" style="text-align: left; width: 200px"><h1 style="font-size: 20px">Sale Invoice&nbsp;</h1> </td>
    ...
    <table border="1" style="width: 700px; margin-top: 10px; border-collapse: collapse;">
        ...
        @if(isset($sales->sale_items) && $sales->sale_items->count() > 0)
            @foreach($sales->sale_items as $item)
            <tr>
