...
<table border="0" style="width:695px; margin-bottom: 2px; margin-top: -50px">
    ...
    @if(!empty($patient->addresses[0]))<p style="text-align: right; margin-top: 30px; margin-bottom: 1px;">
        ...
        @endif
        <p  @if(empty($patient->addresses[0])) style="margin-top: 30px; margin-bottom: 1px"  @else style="margin-top: 2px; margin-bottom: 0" @endif>{!! $patient->patient_email !!}  {!! $patient->patient_phone !!}</p>
