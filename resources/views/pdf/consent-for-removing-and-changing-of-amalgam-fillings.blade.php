...
<table border="0" class="main">
    ...
    <tr>
        <td style="text-align: center">
            <h1>Consent For Removing And Changing Of Amalgam Fillings</h1>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <ol type="A" style="font-size: 10px; line-height: 15px">
                <li>POST-OPERATIVE PAIN, FEVER AND TOOTH SENSITIVITY TO TEMPERATURE AND PRESSURE, SOMETIMES LASTING FOR WEEKS OR MONTHS</li>
                <li>POSSIBLE FRACTURE AND/OR INVOLVEMENT OF THE PULP CHAMBER REQUIRING FURTHER TREATMENTS, ROOT CANAL THERAPY AND/OR CROWN.</li>
                <li>THERE ARE RISKS INVOLVED IN ADMINISTRATION OF ANESTHETICS, ANALGESICS (PAIN MEDICATION) AND ANTIBIOTICS. THE ADMINISTRATION OF THESE DRUGS CAN BRING ABOUT AN
                    ALLERGIC REACTION OR TRIGGER THE ONSET OF A PREVIOUSLY UNDIAGNOSED UNDERLYING SYSTEMIC CONDITION. IN THIS INSTANCE, REFERRAL AND FURTHER TREATMENT MAY BE REQUIRED BY A SEPARATE MEDICAL / DENTAL SPECIALIST OR EVEN HOSPITALIZATION</li>
                <li>POSSIBLE DISLOCATION OF THE TEMPOROMANDIBULAR JOINT (TMJ) AND/OR TENDERNESS DUE OF THE TMJ COMPLEX AND MUSCULATURE.
                </li>
