(function($){
  ...
  var demo = {
    init: function(){
      ...
      demo.barChartInit('#card-sparkline-1', '#cce2e5');
      demo.barChartInit('#card-sparkline-2', '#cce2e5');
      demo.barChartInit('#card-sparkline-3', '#cce2e5');
      demo.barChartInit('#card-sparkline-4', '#cce2e5');
      ...
      // Orders data
      var ordersData = [
        [new Date(2016, 0, 1).getTime(),800],
        [new Date(2016, 0, 10).getTime(),1400],

        [new Date(2016, 1, 1).getTime(),1550],
        [new Date(2016, 1, 15).getTime(),1800],

        [new Date(2016, 2, 1).getTime(),2100],
        [new Date(2016, 3, 1).getTime(),2700],

        [new Date(2016, 4, 1).getTime(),3400],
        [new Date(2016, 4, 20).getTime(),3300],

        [new Date(2016, 5, 5).getTime(),3650],
        [new Date(2016, 5, 20).getTime(),3500],

        [new Date(2016, 6, 1).getTime(),3700],
        [new Date(2016, 6, 10).getTime(),3700],
        [new Date(2016, 6, 25).getTime(),3200],

        [new Date(2016, 7, 1).getTime(),3200],
        [new Date(2016, 7, 25).getTime(),3900],

        [new Date(2016, 8, 1).getTime(),3400],
        [new Date(2016, 8, 15).getTime(),3700],
        [new Date(2016, 8, 25).getTime(),3800],

        [new Date(2016, 9, 5).getTime(),3400],
        [new Date(2016, 9, 15).getTime(),4100],
        [new Date(2016, 9, 25).getTime(),3800],

        [new Date(2016, 10, 5).getTime(),4600],
        [new Date(2016, 10, 15).getTime(),4700],
        [new Date(2016, 10, 25).getTime(),4500],

        [new Date(2016, 11, 10).getTime(),5000],
        [new Date(2016, 11, 20).getTime(),4300],

        [new Date(2016, 12, 1).getTime(),5300],
        [new Date(2016, 12, 15).getTime(),5800]
      ];
      // Orders chart
      demo.lineChartInit('#chart-orders', ordersData, 'Orders', 'rgb(40, 209, 163)', 'rgba(40, 209, 163, .5)', '#22c79a');
      ...
      // Expenses chart
      demo.lineChartInit('#chart-expenses', expensesData, 'Expenses', 'rgb(76, 208, 243)', 'rgba(76, 208, 243, .5)', '#40c3e7');
    ...
    barChartInit: function(el, color){
      $(el).sparkline('html',{
        type: 'bar',
        height: '49',
        barColor: color
    ...
    datatablesTasklistInit: function(el){
      $(el).DataTable({
        ...
        ajax: '/cs-admin/messages/message',
        columns: [
          {
