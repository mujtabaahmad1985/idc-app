!function (t) {
    ...
    var ke = Wt.InteractiveDateComponent = Fe.extend({
        ...
        updateDayTable: function () {
            for (var t, e, n, i = this.view, r = i.calendar,
                     s = r.msToUtcMoment(this.dateProfile.renderUnzonedRange.startMs, !0),
                     o = r.msToUtcMoment(this.dateProfile.renderUnzonedRange.endMs, !0), a = -1, l = [],
                     u = []; s.isBefore(o);)i.isHiddenDay(s) ? l.push(a + .5) : (a++, l.push(a), u.push(s.clone())), s.add(1, "days");
    ...
    Le.mixin({
        ...
        viewSpecCache: null, getViewSpec: function (t) {
            ...
            for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], c = [], h = [],
                     d = t; d;)i = _t[d], r = l[d], d = null, "function" == typeof i && (i = {class: i}), i && (u.unshift(i), c.unshift(i.defaults || {}), s = s || i.duration, d = d || i.type), r && (h.unshift(r), s = s || r.duration, d = d || r.type);
    ...
    var Xe = Qe.extend({
        startTime: null, endTime: null, dowHash: null, isAllDay: function () {
            ...
            for (var e, n, i, r = this.source.calendar, s = t.getStart(), o = t.getEnd(),
                     a = []; s.isBefore(o);)this.dowHash && !this.dowHash[s.day()] || (e = r.applyTimezone(s), n = e.clone(), i = null, this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (i = e.clone().time(this.endTime)), a.push(new Ke(this, new tn(n, i, r)))), s.add(1, "days");
            return a
        }, setDow: function (t) {
    ...
    wn.mixin({
        segPopover: null, popoverSegs: null, removeSegPopover: function () {
            ...
            for (var i, r = this.eventRenderer.rowStructs[t].segMatrix, s = n || 0,
    ...
    var Sn = xe.extend({
        ...
        renderSlatRowHtml: function () {
            for (var t, n, i, r = this.view, s = r.calendar, o = s.theme, a = this.isRTL, l = this.dateProfile, u = "",
    ...
    var zn = Wt.ListView = Ae.extend({
        ...
        renderDates: function (t) {
            for (var e = this.calendar, n = e.msToUtcMoment(t.renderUnzonedRange.startMs, !0),
                     i = e.msToUtcMoment(t.renderUnzonedRange.endMs, !0), r = [],
                     s = []; n < i;)r.push(n.clone()), s.push(new Ue(n, n.clone().add(1, "day"))), n.add(1, "day");
